...
class DataMainPage extends React.Component {
...
const connectedDataMainPage = connect(mapState, actionCreators)(DataMainPage);
export { connectedDataMainPage as DataMainPage };